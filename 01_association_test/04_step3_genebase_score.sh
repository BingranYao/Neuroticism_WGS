...
regenie \
    ...
    --extract /home/dnanexus/Anno_New/chr${chr}/Subset/chr${chr}_${score}.txt \
    --aaf-bins 0.01 \
    ...
    --write-mask-snplist \
    --print-pheno \
    --out /home/dnanexus/step3/qt/chr${chr}_${type}_${score}
...
regenie \
    ...
    --write-mask-snplist \
    --print-pheno \
    --out /home/dnanexus/step3/bt/chr${chr}_${type}_${score}
